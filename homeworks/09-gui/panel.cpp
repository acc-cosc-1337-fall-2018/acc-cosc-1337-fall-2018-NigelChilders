...
wxBoxSizer * Panel::get_mid_box_sizer() {
	...
	auto winner_label = new wxStaticText(this, wxID_ANY, wxT("Winner: "), wxDefaultPosition, wxSize(70, -1));
...
void Panel::on_list_box_click(wxCommandEvent& event) {
	...
	int i = 1;
	for (auto item : sizer->GetChildren()) {	//call board get_pegs[i-1] and call the val data member
